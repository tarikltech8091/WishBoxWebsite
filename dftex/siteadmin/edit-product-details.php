...
<?php
	...
	if(isset($_REQUEST['action']) && $_REQUEST['action']=='edit'){
		$product_details_edit=product_details_edit($_REQUEST['pro_img']);
	}


	/*Product Details Update*/
	if(isset($_REQUEST['product_image_update'])){
		product_details_update($_REQUEST['pro_img']);
		header('Location:product-details.php');
	}
						...
						<div class="alert">
									...
									<?php
									 if(count($all_product_list) > 0) {
										foreach ($all_product_list as $key => $list) {
											if($product_details_edit['product_id']==$list['product_id']){
												echo '<option selected  value='.$list['product_id'].'>'.$list["product_name"].'</option>';
											}
											else
							...
							<div class="form-group">
								...
								<div class="fileupload fileupload-new" data-provides="fileupload">
									...
									<?php
									if(!empty($product_details_edit['product_image_url'])){
										echo '<img src='.$product_details_edit['product_image_url'].' alt="">';
									}else
									echo '<img src="assets/images/avatar-1-xl.jpg" alt="">';

									?>

									</div>

									<input type="hidden" name="edit_content_preview" value="<?php echo isset($product_details_edit['product_image_url']) ? $product_details_edit['product_image_url'] :''; ?>">
							...
							<input class="btn btn-default" type="submit" value="Add" name="product_image_update">
						</form>
					</div>
				</div>
			</div>
