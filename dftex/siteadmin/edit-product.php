...
<?php
	...
	if(isset($_REQUEST['action']) && $_REQUEST['action']=='edit'){
		$product_edit=product_edit($_REQUEST['pro']);
	}


	/*Product Update*/
	if(isset($_REQUEST['product_update'])){
		product_update($_REQUEST['pro']);
		header('Location:products.php');
	}
					...
					<div class="panel-body">
						...
						<form action="" method="POST" >
							<div class="form-group">
								...
								<input type="text"  class="form-control" name="product_name" value="<?php echo isset($product_edit['product_name']) ? $product_edit['product_name'] :''; ?>" >
							</div>
							<div class="form-group">
								<label>Work Area Details</label>
								<textarea cols="10" rows="8" class="form-control" name="product_details" required><?php echo isset($product_edit['product_details']) ? $product_edit['product_details'] :''; ?></textarea>
							</div>
							<input class="btn btn-default" type="submit" value="Add" name="product_update">
						</form>
					</div>
				</div>
			</div>
