...
<?php
	...
	if(isset($_REQUEST['action']) && $_REQUEST['action']=='edit'){
		$social_link_edit=social_link_edit($_REQUEST['ssl']);
	}


	/*Social Link Update*/
	if(isset($_REQUEST['social_site_link_update'])){
		social_link_update($_REQUEST['ssl']);
					...
					<div class="panel-body">
						...
						<form action="" method="POST" enctype="multipart/form-data">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="social_site_name" value="<?php echo $social_link_edit['social_site_name'] ;?>" required="">
							</div>
							<div class="form-group">
								<label>Social Site Url</label>
								<input type="text" class="form-control" name="social_site_url" value="<?php echo $social_link_edit['social_site_url'] ;?>" required="">
							</div>
							<div class="form-group">
								<label>Social Site Icon Class (if any)</label>
								<input type="text" class="form-control" name="social_site_icon_class" value="<?php echo ($social_link_edit['social_site_icon_class'])?$social_link_edit['social_site_icon_class']:'' ;?>">
							</div>


							<input class="btn btn-default" type="submit" value="Add" name="social_site_link_update">
						</form>
					</div>
				</div>
			</div>
