...
<!-- Mirrored from friday-theme.firebaseapp.com/terms_conditions.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 Apr 2017 12:11:56 GMT -->
                        ...
                        <div class="col-sm-12 col-md-8">
                            <ul class="nav-top nav-top-right list-inline t-xs-center t-md-right">
                                <li>
                                    ...
                                    <ul>
                                        <li><a href="terms_conditions.html"><i class="fa fa-flag-en"></i>English</a>
                                        </li>
                                        <li><a href="ar/terms_conditions.html"><i class="fa fa-flag-ar"></i>العربية</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                ...
                <div class="container">
                    <nav class="nav-bar">
                        ...
                        <div class="nav-menu nav-menu-fixed">
                            <a href="ar/terms_conditions.html" target="_blank">RTL VERSION<i class="fa fa-long-arrow-right ml-10"></i></a>
                        </div>
                    </nav>
                </div>
            </div>
